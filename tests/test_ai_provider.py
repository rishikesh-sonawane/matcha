...
class TestAIProviderFunctions(unittest.TestCase):
    def test_check_ai_available_returns_false_when_missing(self):
        ...
        with (
            ...
            mock.patch("matcha.ai._get_api_url", return_value=""),
    ...
    def test_check_ai_available_returns_true_when_all_set(self):
        ...
        with (
            ...
            mock.patch("matcha.ai._get_api_url", return_value="url"),
    ...
    def test_env_vars_override_config(self):
        from matcha.ai import _get_api_key, _get_api_url, _get_model
    ...
    def test_fallback_to_config(self):
        with mock.patch("matcha.ai.load_config") as mock_load:
...
class TestAIEmptyContent(unittest.TestCase):
    @mock.patch("matcha.ai._call_ai", return_value=None)
    ...
    def test_ai_extract_profile_handles_none(self, mock_check, mock_call):
        from matcha.ai import ai_extract_profile
    ...
    def test_ai_generate_queries_handles_none(self, mock_check, mock_call):
        from matcha.ai import ai_generate_queries
...
class TestMaxTokens(unittest.TestCase):
    ...
    def test_scoring_uses_16384(self):
        ...
        with mock.patch(
            ...
            with mock.patch("matcha.ai.check_ai_available", return_value=True):
    ...
    def test_generate_queries_uses_8192(self):
        ...
        with mock.patch(
            "matcha.ai._call_ai", return_value='{"queries": ["python backend"]}'
        ) as mock_call:
            with mock.patch("matcha.ai.check_ai_available", return_value=True):
                ai_generate_queries(
    ...
    def test_suggest_titles_uses_4096(self):
        from matcha.ai import ai_suggest_titles

        with mock.patch(
            "matcha.ai._call_ai", return_value='{"titles": ["DevOps Engineer"]}'
        ) as mock_call:
            with mock.patch("matcha.ai.check_ai_available", return_value=True):
    ...
    def test_extract_profile_uses_16384(self):
        ...
        with mock.patch(
            "matcha.ai._call_ai", return_value='{"name": "Test", "skills": []}'
        ) as mock_call:
            with mock.patch("matcha.ai.check_ai_available", return_value=True):
